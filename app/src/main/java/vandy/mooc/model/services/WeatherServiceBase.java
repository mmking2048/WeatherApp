...
public class WeatherServiceBase 
     ...
     */
    // Appid is defined in local.properties file
    private final String mAppid = BuildConfig.WEB_SERVICE_API_KEY;
    ...
    public void onCreate() {
        ...
        weatherCache = GenericSingleton.instance(WeatherCache.class);
    }
    ...
    protected List<WeatherData> getWeatherResults(String location) {
        ...
        // TODO -- you fill in here.
        List<WeatherData> cachedWeather = weatherCache.get(location);
        ...
        if (cachedWeather != null) {
            ...
            List<WeatherData> weatherDatas = getResultsFromWeatherService(location);

            // Put it in the cache
            weatherCache.put(location, weatherDatas, DEFAULT_CACHE_TIMEOUT);
